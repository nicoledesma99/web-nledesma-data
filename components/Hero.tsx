    ...
    <section className="relative min-h-screen flex flex-col justify-center pt-14">
      <div className="max-w-7xl mx-auto px-6 py-20 w-full">
        ...
        <div className="flex items-center justify-between mb-12">
          <span className="font-mono text-xs text-[#444] tracking-wider uppercase">
            Córdoba, Argentina
          </span>
          <Clock />
        </div>
        ...
        <FadeIn>
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-8 mb-10">
            ...
            <div>
              ...
              <p className="font-mono text-sm text-[#555] tracking-widest uppercase">
                Data & BI Analyst
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-px bg-white/5 border border-white/5 mb-10">
            {stats.map((s) => (
              <div key={s.label} className="bg-[#0a0a0a] px-5 py-4">
                ...
                <p className="font-mono text-xs text-[#444] tracking-wide">{s.label}</p>
              </div>
            ))}
          </div>
        </FadeIn>
        ...
        <FadeIn delay={300}>
          <div className="flex flex-wrap gap-3">
            ...
            <a
              href="#contacto"
              className="px-7 py-3 rounded-full border border-white/25 text-[#ccc] text-sm font-mono hover:border-white/60 hover:text-white transition-all duration-200 tracking-wide"
            >
              Contacto →
            </a>
            <a
              ...
              className="px-7 py-3 rounded-full border border-white/25 text-[#ccc] text-sm font-mono hover:border-white/60 hover:text-white transition-all duration-200 tracking-wide flex items-center gap-2"
            >
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 opacity-30">
        <span className="font-mono text-[10px] text-[#666] uppercase tracking-widest">scroll</span>
